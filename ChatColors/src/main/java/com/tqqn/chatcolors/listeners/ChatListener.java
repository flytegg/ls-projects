...
public class ChatListener implements Listener {
    ...
    public void onAsyncChat(AsyncChatEvent event) {
        ...
        Bukkit.getOnlinePlayers().forEach(players -> players.sendMessage(ChatUtils.format("<white>" + pluginPlayer.getName() + ": " + pluginPlayer.getSelectedColor().getColor() + event.message())));
    }
}
